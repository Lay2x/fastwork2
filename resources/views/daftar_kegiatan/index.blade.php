          ...
          <table id="example1" class="table table-bordered table-striped">
            ...
            <tbody class="overflow-x-auto">
              ...
              <tr>
                ...
                <td>
                  <span class="vibrating-span badge badge-success">Rp. {{ number_format($row->biaya_kegiatan) }}</span>
                </td>
                @else
                <td>
                  <span class="vibrating-span badge badge-success">Rp. {{ number_format($row->biaya_kegiatan) }}</span>
                ...
                <td>
                  <a href="{{ route('daftar_kegiatan.edit', $row->id_daftar_kegiatan) }}" class="btn btn-primary btn-xs" role="button" style="display: inline-block"><i class="fas fa-edit">Edit</i><br>
                    <a href="{{ route('metode.index') }}" class="btn btn-warning btn-xs" style="display: inline-block"> <i class="fas fa-eye"> Pembayaran</i></a>
                  </a>
