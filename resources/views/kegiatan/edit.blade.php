            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group mb-2">
                        ...
                        <input type="text" name="kupon" class="form-control" value="{{ $kegiatan->kupon }}">
                    </div>
                    <div class="form-group mb-2">
                        <label for="">Potongan Harga</label>
                        <input type="number" name="potongan_harga" class="form-control" value="{{ $kegiatan->potongan_harga }}">
                    </div>
                    <div class="form-group mb-2">
