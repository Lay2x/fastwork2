  ...
  <div class="wrapper">
          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="{{route('daftar_kegiatan_user.index')}}" class="{{ request()->is('panel/daftar_kegiatan_user*') ? 'nav-link active' : 'nav-link' }}">
                    <i class="nav-icon fas fa-cube"></i>
                    <p>
            ...
            <li class="nav-item">
              <a href="{{route('paket.index')}}" class="{{ request()->is('panel/paket*') ? 'nav-link active' : 'nav-link' }}">
                <i class="nav-icon fas fa-cube"></i>
                <p>
                  Paket
                </p>
            ...
            <li class="nav-item">
              <a href="{{route('kupon.index')}}" class="{{ request()->is('panel/kupon*') ? 'nav-link active' : 'nav-link' }}">
            ...
            <li class="nav-item">
              <a href="{{route('metode.index')}}" class="{{ request()->is('panel/order*') ? 'nav-link active' : 'nav-link' }}">
            ...
            <li class="nav-item">
              <a href="{{ route('daftar_kegiatan_user.index') }}" class="nav-link">
    ...
    <footer class="main-footer">
      ...
      {{-- <strong>Copyright &copy;
        <?php $cpy = date('Y');
        echo $cpy; ?><a href="{{ route('home.index') }}"> PT. Solusi Pasti Untuk Indonesia</a>.
      </strong> All rights reserved. --}}
      <strong>Copyright &copy;
        <?php $cpy = date('Y');
        echo $cpy; ?><a href="#"> PT. Solusi Pasti Untuk Indonesia</a>.
      </strong> All rights reserved.
    </footer>
